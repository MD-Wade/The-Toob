class Constant:
    """A class for storing constants for Uploader class"""
    ...
    UPLOADING_STATUS_CONTAINER = "//span[contains(@class, 'progress-label')]"
    ...
    PAID_PROMOTION_CHECKBOX = "has-paid-promotion"
    ALTERED_CONTENT_YES_RADIO = "(//tp-yt-paper-radio-button)[5]"
    ALTERED_CONTENT_NO_RADIO = "(//tp-yt-paper-radio-button)[6]"
